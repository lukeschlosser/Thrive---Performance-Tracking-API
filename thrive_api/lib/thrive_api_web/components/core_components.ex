defmodule ThriveApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ThriveApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ThriveApiWeb.Gettext, "errors", msg, opts)
    end
  end
